...
pub struct CreateArenaTournamentForm {
    ...
    #[serde(rename = "teamBattleByTeam")]
    pub team_battle_by_team: Option<String>,
    #[serde(rename = "conditions.teamMember.teamId")]
    pub conditions_team_member_team_id: Option<String>,
...
pub type PostRequest = Request<PostQuery, CreateArenaTournamentForm>;

impl PostRequest {
    pub fn new(form: CreateArenaTournamentForm) -> Self {
        Self::post("/api/tournament", None, Body::Form(form), None)
    }
}

impl From<CreateArenaTournamentForm> for PostRequest {
    fn from(form: CreateArenaTournamentForm) -> Self {
        Self::new(form)
    }
}
